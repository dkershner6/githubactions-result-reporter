...
const getAllInputs_1 = __importDefault(__webpack_require__(210));
const sendStatus_1 = __importDefault(__webpack_require__(560));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const inputs = getAllInputs_1.default();
            yield sendStatus_1.default(inputs);
        }
        catch (err) {
...
const getAllInputs = () => {
    var _a, _b;
    const triggerResultId = core_1.getInput('trigger_result_id');
    if (!triggerResultId) {
        core_1.error('trigger_result_id is a required input, and was not found.');
    }
    const eventResultId = core_1.getInput('event_result_id');
    if (!eventResultId) {
        core_1.error('event_result_id is a required input, and was not found.');
    }
    const statusCode = (_a = core_1.getInput('status_code')) !== null && _a !== void 0 ? _a : 'success';
    const statusText = (_b = core_1.getInput('status_text')) !== null && _b !== void 0 ? _b : 'Success!';
    return { triggerResultId, eventResultId, statusCode, statusText };
};
exports.default = getAllInputs;
...
const core_1 = __webpack_require__(470);
const sendStatus = (inputs) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { triggerResultId, eventResultId, statusCode, statusText, } = inputs;
        yield axios_1.default.patch(`https://githubactions.com/api/trigger_results/${triggerResultId}`, {
            reportedResult: {
                eventResultId,
                code: statusCode,
                text: statusText,
        ...
        if (err.status === 404) {
            core_1.error('Event to update not found');
        }
        else if (err.status === 400) {
            core_1.error(err.text);
        }
        else {
            core_1.error(`Error Response Code: ${err.status}`);
        }
    }
});
